...
# Type a random filename
name3 = generate_random_name(7, 9) + random.choice([".py", ".py", ".py"])
type_like_human(name3, is_filename=True)
...
type_like_human(name4, is_filename=True)

random_sleep(1, 2)
random_click(1220, 283, 1326, 295)
time.sleep(1.5)
random_click(1220, 283, 1326, 295)
random_sleep(5.5, 6.2)
